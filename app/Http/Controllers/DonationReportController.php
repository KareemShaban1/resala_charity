    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return response()->json([
                ...
                // 'inKindDonationsAmount' => $inKindDonationsAmount,
                'financialCollectedDonationsAmount' => $financialCollectedDonationsAmount,
                // 'inKindCollectedDonationsAmount' => $inKindCollectedDonationsAmount,
                'financialNotCollectedDonationsAmount' => $financialNotCollectedDonationsAmount,
                // 'inKindNotCollectedDonationsAmount' => $inKindNotCollectedDonationsAmount
            ]);
        }
